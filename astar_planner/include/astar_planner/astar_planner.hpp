...
private:
  ...
  rclcpp_lifecycle::LifecyclePublisher<nav_msgs::msg::Path>::SharedPtr hybrid_nodes_publisher_;
  rclcpp_lifecycle::LifecyclePublisher<nav_msgs::msg::Path>::SharedPtr dubins_nodes_publisher_;
